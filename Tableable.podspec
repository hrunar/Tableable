...
Pod::Spec.new do |s|
  s.name             = 'Tableable'
  s.version          = '0.1.0'
  s.summary          = 'A short description of Tableable.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/Tableable'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Runar Svendsen' => 'runar.svendsen@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/Tableable.git', :tag => s.version.to_s }
